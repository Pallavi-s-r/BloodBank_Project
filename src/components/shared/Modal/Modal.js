...
const {data} = await API.post('/inventory/create-inventory' , {
  email, inventoryType , bloodGroup , quantity , organisation:user?._id , 
})
console.log('api response ', data)
if(data?.success){
  alert("new invnetory record recorded");
    ...
    <div className="modal-content">
      ...
      <div className="modal-body">
        <div className='d-flex mb-3'>
            ...
            <label htmlFor='in' className='form-check-labelms-3'>IN</label>
            </div>
            <div className='form-check ms-3'>
...
<InputType labelText = {'Qunatity'} labelFor={'quantity'} InputType={'Number'} value={quantity} onChange={(e)=>setQuantity(e.target.value)} />
